            ...
            {workspace.projects.map((project: Project & { _count: { notes: number } }) => {
              ...
              return (
                <Link
                  ...
                  className={`group flex flex-col rounded-xl bg-surface-container-lowest p-6 shadow-ambient transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_16px_48px_rgba(42,52,57,0.10)] ${styles.border}`}
                >
                  {/* Due date + priority */}
